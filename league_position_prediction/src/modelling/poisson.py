...
def calculate_expected_goals(home_team: str,
                            away_team: str,
                            home_stats: pd.DataFrame,
                            away_stats: pd.DataFrame) -> Tuple[float, float]:
    """
...
def simulate_match(home_team: str,
                  away_team: str,
                  home_stats: pd.DataFrame,
                  away_stats: pd.DataFrame) -> Tuple[int, int]:
    """
